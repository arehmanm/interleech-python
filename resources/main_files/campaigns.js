/* XXX:NOTE!!!1! These functions are called from www/js/site/ai.js
 * and the calls need to be removed from there!
 *
 * Extra services B version uses the ads image to visualize
 */
blocket("@apps.ai").extend({
	remove_extra_services_images: function () {
		"use strict";
		var img_url = "/img/transparent.gif";
		blocket.apps.ai.set_extra_services_images(img_url);
	},
	set_extra_services_images: function (img_url) {
		"use strict";
		$(".extra_services_image_holder").css('background-image', 'url(' + img_url + ')');
	}
});
