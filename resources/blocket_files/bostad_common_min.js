blocket("@apps.bostad_common").extend({
	onReady : function () {
		...
		$("#subheader #types a").on("click", blocket.apps.bostad_common.banner_hide);
	...
	banner_hide : function () {
		"use strict";
		blocket.common.setCookie(blocket.bconf.bostad.front_page.cookie_name, 1, blocket.bconf.bostad.front_page.cookie_expires, "/", blocket.bconf.common.cookie_domain);
	},

	banner_show : function () {
		"use strict";
		blocket.common.deleteCookie(blocket.bconf.bostad.front_page.cookie_name, "/", blocket.bconf.common.cookie_domain);
	},
